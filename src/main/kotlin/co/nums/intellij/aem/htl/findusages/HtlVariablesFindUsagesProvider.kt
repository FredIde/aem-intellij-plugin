...
import co.nums.intellij.aem.htl.psi.HtlTypes.BOOLEAN_FALSE
import co.nums.intellij.aem.htl.psi.HtlTypes.BOOLEAN_TRUE
...
class HtlVariablesFindUsagesProvider : FindUsagesProvider {
    ...
    override fun getWordsScanner() = DefaultWordsScanner(
            ...
            TokenSet.create(STRING_LITERAL, INTEGER_NUMBER, FLOAT_NUMBER, BOOLEAN_TRUE, BOOLEAN_FALSE)
    )
